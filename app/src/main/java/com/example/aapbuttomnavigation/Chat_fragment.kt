...
class Chat_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.JoinButton.setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_chat_fragment_to_join_fragment2)}
        view.DonateButton.setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_chat_fragment_to_donate_fragment2)}
        return view
    }
